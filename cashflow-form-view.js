                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    {!isCashflowOneTime && (
                        <div className={`space-y-1 ${isCashflowMonthlyRecurring ? '' : 'col-span-2'}`}>
                            ...
                            <div className="text-[10px] text-slate-400 font-bold ml-1">可留空：留空代表長期規則（沒有結束日期）。</div>
                        </div>
                    )}
                </div>
                    ...
                    <div className="mt-3 space-y-3">
                        ...
                        <div className="space-y-1">
                            ...
                            {cashflowForm.targetLiquidAssetId && (
                                <div className="text-[10px] text-slate-400 font-bold ml-1">已綁定流動資金帳戶，會在符合規則日期時入帳/扣款。</div>
                            )}
                        </div>
                        <div className="space-y-1">
